...
import com.tonyimage.imagepicker.DataHolder;
import com.tonyimage.imagepicker.ImageDataSource;
import com.tonyimage.imagepicker.ImagePicker;
import com.tonyimage.imagepicker.adapter.ImageFolderAdapter;
import com.tonyimage.imagepicker.adapter.ImageRecyclerAdapter;
import com.tonyimage.imagepicker.bean.ImageFolder;
import com.tonyimage.imagepicker.bean.ImageItem;
import com.tonyimage.imagepicker.view.FolderPopUpWindow;
 ...
 *         ================================================
 */
public class ImageGridActivity extends ImageBaseActivity implements ImageRecyclerAdapter.OnImageItemClickListener,
        ImagePicker.OnImageSelectedListener,
        View.OnClickListener, ImageDataSource.OnImagesLoadedListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_ok) {
            ...
            if (mFolderPopupWindow.isShowing()) {
                ...
                //将popupWindow显示到指定的位置,从屏幕的左上角开始.
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data != null && data.getExtras() != null) {
            ...
            if (resultCode == RESULT_OK && requestCode == ImagePicker.REQUEST_CODE_TAKE) {
                //发送广播通知图片增加了
                ImagePicker.galleryAddPic(this, imagePicker.getTakeImageFolder());

                //这里的路径就是imagePicker中初始化的
                String path = imagePicker.getTakeImageFolder().getAbsolutePath();
                //2017-03-21 对机型做旋转处理
...
//                }
                ...
                imageItem.path = path;
                imagePicker.clearSelectedImages();
                imagePicker.addSelectedImageItem(0, imageItem, true);//将拍摄返回的照片加入到gridVie管理集合中
