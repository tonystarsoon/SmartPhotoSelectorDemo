package com.tonyimage.imagepicker.adapter;
...
import com.tonyimage.imagepicker.ui.ImageBaseActivity;
import com.tonyimage.imagepicker.ui.ImageGridActivity;
import com.tonyimage.imagepicker.util.Utils;
import com.tonyimage.imagepicker.view.SuperCheckBox;
...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (itemViewType == ITEM_TYPE_CAMERA) {
            convertView = LayoutInflater.from(mActivity).inflate(R.layout.camera_item, parent, false);
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(mActivity).inflate(R.layout.image_list_item, parent, false);
                convertView.setLayoutParams(new AbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, mImageSize)); //让图片是个正方形
