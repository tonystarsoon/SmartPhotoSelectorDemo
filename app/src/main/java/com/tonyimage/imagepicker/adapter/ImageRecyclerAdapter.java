...
public class ImageRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE_CAMERA) {
            return new CameraViewHolder(mInflater.inflate(R.layout.camera_item, parent, false));
        }
    ...
    private class ImageViewHolder extends ViewHolder {
        ...
        void bind(final int position) {
            ...
            if (imageLoader != null) {
                imageLoader.displayImage(mActivity, imageItem.path, ivThumb, mImageSize, mImageSize); //显示图片
            }
        }
    }
