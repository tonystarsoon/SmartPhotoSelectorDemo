package com.tonyimage.imagepicker.view;
...
public class FolderPopUpWindow extends PopupWindow implements View.OnClickListener {
    ...
    public FolderPopUpWindow(Context context, BaseAdapter adapter) {
        ...
        setContentView(view);
        setWidth(ViewGroup.LayoutParams.MATCH_PARENT);//设置整个popupwindow是填充父窗体 --> 如果不设置，就是 AnchorView 的宽度
    ...
    //点击popupWindow的外部直接让popupWindow消失.
    @Override
